"""
Django settings for bande_cv project.
...
SECRET_KEY = 'django-insecure-trx=zxsak$e)qhm$fr^c!@0)qt!sj%se07$v1=66y!oxli(om)'
...
WSGI_APPLICATION = 'bande_cv.wsgi.application'
